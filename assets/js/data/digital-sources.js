...
// cat: 'law' (нормативные акты), 'tech' (тех. замеры), 'rights' (правозащита),
//      'biz' (деловые), 'state' (госисточники), 'state-media' (госСМИ),
//      'indep' (независимые СМИ), 'expert' (эксперты)
window.DIGITAL_SOURCES = [
  ...
  // Правозащитные / исследовательские
...
window.DIGITAL_SOURCE_CATS = [
  { id: 'law',          label: 'Нормативные акты' },
  { id: 'tech',         label: 'Технические замеры' },
  { id: 'rights',       label: 'Правозащитные организации' },
  { id: 'biz',          label: 'Деловые СМИ' },
  { id: 'state',        label: 'Государственные источники' },
  { id: 'state-media',  label: 'Государственные СМИ' },
  { id: 'indep',        label: 'Независимые СМИ' },
  { id: 'expert',       label: 'Эксперты и аналитики' },
];
