// EN translation of assets/js/lib/github-fab.js
// Sync source: assets/js/lib/github-fab.js
...
(function () {
  ...
  function inject() {
    ...
    a.target = '_blank';
    a.rel = 'noopener';
    a.setAttribute('aria-label', 'Site source code on GitHub');
    a.title = 'Site source code on GitHub';
    a.innerHTML = `
