// EN translation of assets/js/charts/years-chart.js
// Sync source: assets/js/charts/years-chart.js
...
window.renderYearsChart = function () {
  ...
  new Chart(el, {
    ...
    data: {
      labels: years,
      datasets: [
        { label: 'Bloc vote against', data: fullVals, backgroundColor: '#15803D', borderRadius: 6, stack: 'a' },
        { label: 'Abstention / faction split', data: partialVals, backgroundColor: '#D97706', borderRadius: 6, stack: 'a' },
      ],
    },
    options: {
      responsive: true,
      ...
      scales: {
        y: {
          ...
          title: { display: true, text: 'Opposition voting episodes', color: '#6B6760', font: { size: 12 } }
        },
        x: {
