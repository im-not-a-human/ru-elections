// EN translation of assets/js/charts/distortion.js
// Sync source: assets/js/charts/distortion.js
// Glossary: research/i18n_glossary_draft.md

// Distortion bars: side-by-side "% of votes" vs "% of seats" for each party.
...
window.renderDistortion = function (selector, parties) {
  ...
  el.innerHTML = `
    <div class="distortion-row" style="font-size:11px; letter-spacing:0.1em; text-transform:uppercase; color:var(--ink-muted); font-weight:600;">
      <div class="distortion-label">Party</div>
      <div>List votes</div>
      <div></div>
      <div>Seats in the Duma</div>
      <div></div>
    </div>
    ${rows}
  `;
