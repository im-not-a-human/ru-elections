// EN translation of assets/js/charts/youtube-throttling.js
// Sync source: assets/js/charts/youtube-throttling.js
  ...
  new Chart(el, {
    ...
    data: {
      ...
      datasets: [
        ...
        {
          label: 'Netherlands (VPN traffic receivers)',
          data: nl,
          borderColor: '#15803D',
    ...
    options: {
      ...
      scales: {
        y: {
          ...
          title: { display: true, text: 'Traffic index (Google Transparency Report)', color: '#6B6760', font: { size: 12 } },
        },
        x: {
