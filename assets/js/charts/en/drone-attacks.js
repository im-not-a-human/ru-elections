// EN translation of assets/js/charts/drone-attacks.js
// Sync source: assets/js/charts/drone-attacks.js
// Glossary: research/i18n_glossary_draft.md

// Drone attacks on Russia — Security Council of Russia (Shoigu, March 2026).
      ...
      plugins: {
        ...
        tooltip: {
          ...
          callbacks: {
            ...
            label: (ctx) => `${ctx.parsed.x.toLocaleString('en-GB')} UAV attacks`,
            afterLabel: (ctx) => ctx.dataIndex === 1 ? '×3.7 compared to 2024' : '',
          }
        }
      }
    }
