// EN translation of assets/js/charts/districts.js
// Sync source: assets/js/charts/districts.js
// Glossary: research/i18n_glossary_draft.md

// Districts grid: 15×15 = 225 single-mandate districts, colour-coded by winning party.
...
window.renderDistrictsGrid = function (selector, partyResults) {
  ...
  // Should be 225 total
  while (cells.length < 225) cells.push({ color: 'var(--line-soft)', party: '—', name: 'no data' });
  cells.length = 225;

  // Group by party so neighbours share colour (visually cleaner)
  ...
  $$('.district-cell', el).forEach((cell) => {
    cell.addEventListener('mouseenter', (e) => {
      if (typeof showTooltip === 'function') {
        showTooltip(e, `<strong>${cell.dataset.name}</strong><br>1 single-mandate district`);
      }
    });
