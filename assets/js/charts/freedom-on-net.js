...
window.renderFreedomOnNet = function () {
  ...
  if (el && typeof Chart !== 'undefined' && typeof FON_RUSSIA !== 'undefined') {
    new Chart(el, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Россия (Freedom on the Net)',
      ...
      options: {
        ...
        scales: {
          y: {
            ...
            title: { display: true, text: 'Балл свободы интернета (0–100, выше = свободнее)', color: '#6B6760', font: { size: 11 } },
          },
          x: {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            callbacks: {
              label: (ctx) => `Россия: ${ctx.parsed.y}/100`,
              afterLabel: (ctx) => ctx.dataIndex === 4 ? 'новый минимум; статус Not Free' : '',
            }
          }
        }
      }
  ...
  if (lb && typeof FON_LEADERBOARD !== 'undefined') {
    lb.innerHTML = `
      <div style="font-size: 11px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: var(--ink-muted); margin-bottom: 6px;">Соседи РФ по индексу 2025</div>
