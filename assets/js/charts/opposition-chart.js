    ...
    options: {
      ...
      scales: {
        x: {
          ...
          title: { display: true, text: `Эпизодов отступления (из ${LAWS.length} законов)`, color: '#6B6760', font: { size: 12 } }
        },
        y: {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          padding: 12,
          callbacks: { label: (ctx) => `${ctx.parsed.x} из ${LAWS.length} законов` }
        }
      }
    }
  });
