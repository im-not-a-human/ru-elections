// EN translation of assets/js/components/liquidation-strip.js
// Sync source: assets/js/components/liquidation-strip.js
// See research/i18n_glossary_draft.md and research/i18n_locked_decisions.md

// U8 — Liquidation strip: horizontal time-strip of 3+ Supreme Court dissolutions of small
...
(function() {
  ...
  window.renderLiquidationStrip = function(rootEl, events, activeId) {
    ...
    var html =
      '<div class="liquidation-strip" role="group" aria-label="Timeline of small-party dissolutions">' +
