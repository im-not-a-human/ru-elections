// EN translation of assets/js/components/vote-bar.js
// Sync source: assets/js/components/vote-bar.js
// See research/i18n_glossary_draft.md and research/i18n_locked_decisions.md

// Renders a stacked vote bar for a single faction's vote on a single law.
//
// Usage:
//   renderVoteBar(rootEl, {
//     law: '04.03.2022 false information about the army FZ-32',
...
window.renderVoteBarLegend = function renderVoteBarLegend(rootEl) {
  ...
  rootEl.insertAdjacentHTML('beforeend', `
    <div class="ch-legend">
      <span><i style="background:var(--vote-against)"></i>'For'</span>
      <span><i style="background:var(--vote-za)"></i>'Against'</span>
      <span><i style="background:var(--vote-abstain)"></i>Abstained</span>
      <span><i style="background:var(--vote-didnt)"></i>Absent</span>
      <span style="margin-left:auto">for/against/abs./absent</span>
    </div>
  `);
};
